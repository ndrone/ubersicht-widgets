...
bkground		= 'rgba(#000000, 0.0)'
lineColor		= 'rgba(#000000, 0.0)'
...
update: (output,domEl) ->
  ...
  switch
    ...
    when osVersion.substr(0,5) == "11.0" then (document.getElementById("osIcon").src = "os_version_pro.widget/icons/mac_os.png") && (osRelease = ' Big Sur')
